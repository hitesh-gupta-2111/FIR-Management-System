<?php
  function poilce_past_cases ($conn, $inchargeid)
  {
	$query = "SELECT Case_Status.Case_Id,Crime.Crime_Type,Case_Status.Progress_Description,
          	FROM Crime inner join  Case_Status on Crime.Case_Id = Case_Status.Case_Id
          	WHERE  Case_Status.Case_Incharge_Appointed= ".$inchargeid ." ";
  ...
  echo "<h1>Table: Police Past cases Details </h1>";
