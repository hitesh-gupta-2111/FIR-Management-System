<?php
  function reg_cases ($conn, $date)
  {
	$query = "SELECT Registration.Crime_Type as 'Crime Type',count(Registration.Case_Id) as 'Number of Cases'
          	FROM Registration
          	WHERE  Registration.Date_Of_Crime>= ".$date ." ";
  $query = $query . "group by Registration.Crime_Type" ;
  ...
  echo "<h1>Table: Registered Cases </h1>";
